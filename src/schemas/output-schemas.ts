...
import { z } from 'zod';
import { ThinkingMethodTypeSchema, ThinkingProcessStatusSchema, BaseOutputFieldsSchema } from './base.js';
 ...
 * アブダクション思考の出力スキーマ
 */
export const AbductionOutputSchema = BaseOutputFieldsSchema.extend({
 ...
 * 批判的思考の出力スキーマ
 */
export const CriticalOutputSchema = BaseOutputFieldsSchema.extend({
 ...
 * ディベート思考の出力スキーマ
 */
export const DebateOutputSchema = BaseOutputFieldsSchema.extend({
 ...
 * 演繹的思考の出力スキーマ
 */
export const DeductiveOutputSchema = BaseOutputFieldsSchema.extend({
 ...
 * 帰納的思考の出力スキーマ
 */
export const InductiveOutputSchema = BaseOutputFieldsSchema.extend({
 ...
 * ロジカルシンキングの出力スキーマ
 */
export const LogicalOutputSchema = BaseOutputFieldsSchema.extend({
 ...
 * MECE思考の出力スキーマ
 */
export const MECEOutputSchema = BaseOutputFieldsSchema.extend({
 ...
 * メタ思考の出力スキーマ
 */
export const MetaOutputSchema = BaseOutputFieldsSchema.extend({
 ...
 * PAC思考の出力スキーマ
 */
export const PACOutputSchema = BaseOutputFieldsSchema.extend({
